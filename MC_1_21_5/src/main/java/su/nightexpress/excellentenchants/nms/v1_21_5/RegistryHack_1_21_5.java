...
public class RegistryHack_1_21_5 implements RegistryHack {
    ...
    public RegistryHack_1_21_5(@NotNull NightPlugin plugin) {
        this.plugin = plugin;
    }
...
//    }
    ...
    public void unfreezeRegistry() {
        ...
        ItemSetRegistry.getByIdMap().forEach(RegistryHack_1_21_5::createItemsSet);
    }
