...
public class RegistryHack_1_21_4 implements RegistryHack {
    ...
    public RegistryHack_1_21_4(@NotNull NightPlugin plugin) {
        this.plugin = plugin;
    }
...
//    }
    ...
    private static /*HolderSet.Named<Item>*/ void createItemsSet(@NotNull String id, @NotNull ItemSet category) {
