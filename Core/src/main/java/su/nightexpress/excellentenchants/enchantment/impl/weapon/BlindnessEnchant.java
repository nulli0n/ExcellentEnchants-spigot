...
public class BlindnessEnchant extends AbstractEnchantmentData implements ChanceData, PotionData, CombatEnchant {
    ...
    protected void loadAdditional(@NotNull FileConfig config) {
        this.chanceSettings = ChanceSettingsImpl.create(config, Modifier.add(7, 3, 1, 100));
