...
public class ParalyzeEnchant extends GameEnchantment implements ChanceMeta, PotionMeta, CombatEnchant {
    ...
    protected void loadAdditional(@NotNull FileConfig config) {
        this.meta.setProbability(Probability.create(config, Modifier.add(2, 3, 1, 100)));
