...
public class ExhaustEnchant extends AbstractEnchantmentData implements ChanceData, PotionData, CombatEnchant {
    ...
    protected void loadAdditional(@NotNull FileConfig config) {
        this.chanceSettings = ChanceSettingsImpl.create(config, Modifier.add(5, 5, 1, 100));

        this.potionSettings = PotionSettingsImpl.create(this, config, PotionEffectType.HUNGER, false,
            Modifier.add(8, 2, 1, 600),
