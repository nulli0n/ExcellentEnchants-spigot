...
public class ExhaustEnchant extends GameEnchantment implements ChanceMeta, PotionMeta, CombatEnchant {
    ...
    protected void loadAdditional(@NotNull FileConfig config) {
        ...
        this.meta.setPotionEffects(PotionEffects.create(this, config, PotionEffectType.HUNGER, false,
